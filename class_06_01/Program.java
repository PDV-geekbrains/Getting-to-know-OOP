...
public class Program {
    ...
    private static List<IToy> getToys() {
        List<IToy> toys = new LinkedList<>();
     ...
     */
    private static List<IToy> getSortedList(List<IToy> toys, ToyComparator comparator) {
     ...
     * @param toys - список.
     */
    private static void Print(List<IToy> toys) {
        for(IToy toy : toys)
